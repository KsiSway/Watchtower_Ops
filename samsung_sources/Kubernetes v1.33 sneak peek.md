---
sourceFile: "Kubernetes v1.33 sneak peek"
exportedBy: "Kortex"
exportDate: "2026-05-20T06:50:17.433Z"
---

# Kubernetes v1.33 sneak peek

990b56b8-aa66-47eb-9186-e06fa7d14e97

Kubernetes v1.33 sneak peek

0d3736fc-4779-46d8-a1f0-8cd040d3f60c

https://kubernetes.io/blog/2025/03/26/kubernetes-v1-33-upcoming-changes/

Kubernetes v1.33 sneak peek | Kubernetes
...
https://kubernetes.io/zh-cn/blog/2025/03/26/kubernetes-v1-33-upcoming-changes/

日本語 (Japanese)

https://kubernetes.io/ja/blog/2025/03/26/kubernetes-v1-33-upcoming-changes/
...
Agustina Barbetta, Aakanksha Bhende, Udi Hofesh, Ryota Sawada, Sneha Yadav
...
API has been stable since v1.21, which effectively replaced the original Endpoints API. While the original Endpoints API was simple and straightforward, it also posed some challenges when scaling to large numbers of network endpoints. The EndpointSlices API has introduced new features such as dual-stack networking, making the original Endpoints API ready for deprecation.
...
https://kep.k8s.io/4974

Removal of kube-proxy version information in node status

Following its deprecation in v1.31, as highlighted in the
...
field will be removed in v1.33. This field was set by kubelet, but its value was not consistently accurate. As it has been disabled by default since v1.31, the v1.33 release will remove this field entirely.

You can find more in

KEP-4004: Deprecate status.nodeInfo.kubeProxyVersion field

https://kep.k8s.io/4004
...
One of the oldest open KEPs today is

https://kep.k8s.io/127

, Pod security improvement by using Linux

User namespaces

https://kubernetes.io/docs/concepts/workloads/pods/user-namespaces/

for Pods. This KEP was first opened in late 2016, and after multiple iterations, had its alpha release in v1.25, initial beta in v1.30 (where it was disabled by default), and now is set to be a part of v1.33, where the feature is available by default.

This support will not impact existing Pods unless you manually specify

pod.spec.hostUsers

to opt in. As highlighted in the

v1.30 sneak peek blog

https://kubernetes.io/blog/2024/03/12/kubernetes-1-30-upcoming-changes/

, this is an important milestone for mitigating vulnerabilities.
...
field in ResourceClaim

, originally introduced in the v1.32 release, is likely to graduate to beta in v1.33. This field allows drivers to report device status data, improving both observability and troubleshooting capabilities.

For example, reporting the interface name, MAC address, and IP addresses of network interfaces in the status of a ResourceClaim can significantly help in configuring and managing network services, as well as in debugging network related issues. You can read more about ResourceClaim Device Status in

Dynamic Resource Allocation: ResourceClaim Device Status

https://kubernetes.io/docs/concepts/scheduling-eviction/dynamic-resource-allocation/#resourceclaim-device-status

Also, you can find more about the planned enhancement in

KEP-4817: DRA: Resource Claim Status with possible standardized network interface data

https://kep.k8s.io/4817
...
https://kep.k8s.io/5080

Enhancements for indexed job management

These two KEPs are both set to graduate to GA to provide better reliability for job handling, specifically for indexed jobs.

https://kep.k8s.io/3850

provides per-index backoff limits for indexed jobs, which allows each index to be fully independent of other indexes. Also,

https://kep.k8s.io/3998

extends Job API to define conditions for making an indexed job as successfully completed when not all indexes are succeeded.
...
Kubernetes v1.33 release is planned for
