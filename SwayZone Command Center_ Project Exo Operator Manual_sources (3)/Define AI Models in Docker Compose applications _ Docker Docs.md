---
sourceFile: "Define AI Models in Docker Compose applications | Docker Docs"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.265Z"
---

# Define AI Models in Docker Compose applications | Docker Docs

ebae7003-6554-4b62-92a9-68db4bcfa4bc

Define AI Models in Docker Compose applications | Docker Docs

dc38c6aa-c6d2-44d3-86ce-dc334bdf8185
...
https://docs.docker.com/ai/compose/models-and-compose/#prerequisites

What are Compose models?

https://docs.docker.com/ai/compose/models-and-compose/#what-are-compose-models

Basic model definition

https://docs.docker.com/ai/compose/models-and-compose/#basic-model-definition

Model configuration options

https://docs.docker.com/ai/compose/models-and-compose/#model-configuration-options
...
https://docs.docker.com/ai/compose/models-and-compose/#long-syntax

Platform portability

https://docs.docker.com/ai/compose/models-and-compose/#platform-portability

Docker Model Runner

https://docs.docker.com/ai/compose/models-and-compose/#docker-model-runner

Cloud providers

https://docs.docker.com/ai/compose/models-and-compose/#cloud-providers

Common runtime configurations

https://docs.docker.com/ai/compose/models-and-compose/#common-runtime-configurations

Development

https://docs.docker.com/ai/compose/models-and-compose/#development

Conservative with disabled reasoning

https://docs.docker.com/ai/compose/models-and-compose/#conservative-with-disabled-reasoning

Creative with high randomness

https://docs.docker.com/ai/compose/models-and-compose/#creative-with-high-randomness

Highly deterministic

https://docs.docker.com/ai/compose/models-and-compose/#highly-deterministic

Concurrent processing

https://docs.docker.com/ai/compose/models-and-compose/#concurrent-processing

Rich vocabulary model

https://docs.docker.com/ai/compose/models-and-compose/#rich-vocabulary-model

https://docs.docker.com/ai/compose/models-and-compose/#embeddings

https://docs.docker.com/ai/compose/models-and-compose/#reference
...
A platform that supports Compose models such as

Docker Model Runner (DMR)

https://docs.docker.com/ai/model-runner/#requirements

What are Compose models?

https://docs.docker.com/ai/compose/models-and-compose/#what-are-compose-models

are a standardized way to define AI model dependencies in your application. By using the

models top-level element

https://docs.docker.com/reference/compose-file/models/

in your Compose file, you can:
...
To define models in your Compose application, use the
...
(required): The OCI artifact identifier for the model. This is what Compose pulls and runs via the model runner.

context\_size

: Defines the maximum token context size for the model. Note Each model has its own maximum context size. When increasing the context length, consider your hardware constraints. In general, try to keep context size as small as feasible for your specific needs.

runtime\_flags

: A list of raw command-line flags passed to the inference engine when the model is started. See

Configuration options

https://docs.docker.com/ai/model-runner/configuration/

for commonly used parameters and examples.

Platform-specific options may also be available via extension attributes

See more example in the
...
- URL to access the LLM model
- Model identifier for the LLM model

EMBEDDING\_MODEL\_URL

- URL to access the embedding-model

EMBEDDING\_MODEL\_MODEL
...
services:
  app:
    ...
    models:
      llm:
        endpoint\_var: AI\_MODEL\_URL
        model\_var: AI\_MODEL\_NAME
      embedding-model:
        endpoint\_var: EMBEDDING\_URL
        model\_var: EMBEDDING\_NAME
...
Docker Model Runner is enabled
...
The Compose models specification is portable. Platforms that implement the Compose specification can support the

top-level element, allowing the same Compose file to run on different infrastructure. Cloud-specific behavior can be configured using extension attributes (
...
services:
  app:
    ...
    models:
      dev\_model:
        endpoint\_var: DEV\_URL
        model\_var: DEV\_MODEL
...
services:
  app:
    ...
    models:
      conservative\_model:
        endpoint\_var: CONSERVATIVE\_URL
        model\_var: CONSERVATIVE\_MODEL
...
services:
  app:
    ...
    models:
      creative\_model:
        endpoint\_var: CREATIVE\_URL
        model\_var: CREATIVE\_MODEL
...
services:
  app:
    image: app
    models:
      deterministic\_model:
        endpoint\_var: DET\_URL
        model\_var: DET\_MODEL
...
services:
  app:
    ...
    models:
      concurrent\_model:
        endpoint\_var: CONCURRENT\_URL
        model\_var: CONCURRENT\_MODEL
...
services:
  app:
    ...
    models:
      rich\_vocab\_model:
        endpoint\_var: RICH\_VOCAB\_URL
        model\_var: RICH\_VOCAB\_MODEL
...
When using embedding models with the
...
runtime flag for the model to be properly configured.
...
https://docs.docker.com/reference/compose-file/services/#models
...
- Context size and runtime parameters
...
https://github.com/docker/docs/edit/main/content/manuals/ai/compose/models-and-compose.md

Request changes

https://github.com/docker/docs/issues/new?template=doc\_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fai%2fcompose%2fmodels-and-compose%2f&labels=status%2Ftriage
