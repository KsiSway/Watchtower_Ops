---
sourceFile: "Planning with agents in VS Code"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.679Z"
---

# Planning with agents in VS Code

26d66a0e-82a5-4202-a8bc-6aca53c38cef

Planning with agents in VS Code

ba10e2ac-27d4-4a12-85fd-93cd3c0a836f
...
https://code.visualstudio.com/docs/copilot/agents/planning#setup-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#getstarted-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#copilot-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#copilot-concepts-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#copilot-agents-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#copilot-chat-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#copilot-customization-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#copilot-guides-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#copilot-reference-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#configure-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#configure-extensions-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#configure-accessibility-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#editing-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#editing-workspaces-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#debugtest-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#sourcecontrol-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#terminal-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#enterprise-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#languages-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#nodejs-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#typescript-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#python-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#java-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#cpp-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#csharp-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#containers-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#datascience-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#intelligentapps-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#intelligentapps-reference-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#azure-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#remote-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#devcontainers-articles
...
https://code.visualstudio.com/docs/copilot/agents/planning#reference-articles
...
On this page there are 3 sections On this page

How to plan a task

https://code.visualstudio.com/docs/copilot/agents/planning#\_how-to-plan-a-task

Customize planning

https://code.visualstudio.com/docs/copilot/agents/planning#\_customize-planning

Related resources

https://code.visualstudio.com/docs/copilot/agents/planning#\_related-resources
...
vscode://GitHub.Copilot-Chat/chat?agent=agent%26prompt=%2Fplan%20a%20terminal%20UI%20app%20to%20track%20my%20todo%20list.
...
For background on how the plan agent fits into the agent architecture, see

Agents concepts

https://code.visualstudio.com/docs/copilot/concepts/agents#\_planning
...
To plan a task, use the built-in

agent in the Chat view, describe your task, and iterate on the generated plan.

Open the Chat view by pressing ⌃⌘I (Windows, Linux Ctrl+Alt+I) and select

from the agents dropdown Alternatively, type

followed by your task description to switch to the Plan agent and start planning in one step.

Enter a high-level task (feature, refactoring, bug, etc.) and submit it. For example: Prompt (Plan)

Implement a user authentication system with OAuth2 and JWT

slash command to start planning directly from the chat input box: Prompt
...
When the plan is finalized, choose to start the implementation or open the planning prompt in the editor for further review. To implement the plan, you can continue in the same session or start a new

Copilot CLI session

https://code.visualstudio.com/docs/copilot/agents/copilot-cli

to implement the plan in the background.

The Plan agent automatically saves its implementation plan to a session memory file (

/memories/session/plan.md

). To access this file, run the

Chat: Show Memory Files

command and select

from the list. Session memory is cleared when the conversation ends, so the plan is not available in subsequent sessions.
...
Create a custom planning agent.

custom agent

https://code.visualstudio.com/docs/copilot/customization/custom-agents

with specific instructions for your planning process, such as enforcing architectural guidelines or requiring specific planning deliverables.

Choose models for planning and implementation.

Use the chat.planAgent.defaultModel Open in VS Code Open in VS Code Insiders setting to select a default model for the plan agent, and github.copilot.chat.implementAgent.model Open in VS Code Open in VS Code Insiders for the implementation step.

Add extra tools to the plan agent (experimental).

Use the github.copilot.chat.planAgent.additionalTools Open in VS Code Open in VS Code Insiders setting to give the plan agent access to additional tools during the research and planning phases. For example, use an MCP server to connect to internal data sources or tools.
