---
sourceFile: "Docker Agent | Docker Docs"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.282Z"
---

# Docker Agent | Docker Docs

d5ec2f0b-6ba9-4583-913c-f6f15be18bd5

Docker Agent | Docker Docs

a9cb25fa-71a9-4bbe-a118-043e697eefdb
...
https://docs.docker.com/ai/docker-agent/#why-agent-teams

Installation

https://docs.docker.com/ai/docker-agent/#installation

Get started

https://docs.docker.com/ai/docker-agent/#get-started

How it works

https://docs.docker.com/ai/docker-agent/#how-it-works

Configuration options

https://docs.docker.com/ai/docker-agent/#configuration-options

Share agent teams

https://docs.docker.com/ai/docker-agent/#share-agent-teams

What's next

https://docs.docker.com/ai/docker-agent/#whats-next

Docker Agent

https://github.com/docker/docker-agent

is an open-source framework for building teams of specialized AI agents. Instead of prompting one generalist model, you define agents with specific roles and instructions that collaborate to solve problems. Run these agent teams from your terminal using any LLM provider.

Docker Agent is a framework for building and running custom agent teams. For Docker's built-in AI assistant, see
...
The root agent investigates and explains the problem. When it understands the issue, it hands off to

for implementation. Each agent stays focused on its specialty.
...
Docker Agent repository

https://github.com/docker/docker-agent?tab=readme-ov-file#build-from-source

docker-agent

binary should be copied to

~/.docker/cli-plugins

and then can be used with the

docker agent

command. Alternatively, it can be used as a standalone binary.
...
$ export ANTHROPIC\_API\_KEY=<your\_key>  # For Claude models
$ export OPENAI\_API\_KEY=<your\_key>     # For OpenAI models
$ export GOOGLE\_API\_KEY=<your\_key>     # For Gemini models
...
, which can delegate work to sub-agents you define. Each agent:
...
The root agent delegates tasks to agents listed under
...
You can also configure model settings (like context limits), tools (including MCP servers), and more. See the
...
to build your first coding agent
...
Integrate Docker Agent with your

https://docs.docker.com/ai/docker-agent/integrations/acp/

or use agents as

tools in MCP clients

https://docs.docker.com/ai/docker-agent/integrations/mcp/

Browse example agent configurations in the
...
to generate agent teams with AI
...
https://github.com/docker/docker-agent?tab=readme-ov-file#-configuration-reference

Edit this page

https://github.com/docker/docs/edit/main/content/manuals/ai/docker-agent/\_index.md

Request changes

https://github.com/docker/docs/issues/new?template=doc\_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fai%2fdocker-agent%2f&labels=status%2Ftriage
