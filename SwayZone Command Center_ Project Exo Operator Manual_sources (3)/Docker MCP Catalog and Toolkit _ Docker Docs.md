---
sourceFile: "Docker MCP Catalog and Toolkit | Docker Docs"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.298Z"
---

# Docker MCP Catalog and Toolkit | Docker Docs

8f3477e9-34a1-46b5-a4d9-06dfded51cd0

Docker MCP Catalog and Toolkit | Docker Docs

734a84b7-50cf-4b9c-acb2-bcaf1564982a
...
https://docs.docker.com/ai/mcp-catalog-and-toolkit/#docker-mcp-features

https://docs.docker.com/ai/mcp-catalog-and-toolkit/#learn-more
...
(MCP) is an open protocol that standardizes how AI applications access external tools and data sources. By connecting LLMs to local development tools, databases, APIs, and other resources, MCP extends their capabilities beyond their base training.
...
solve these challenges through centralized management. Instead of configuring each server for every AI application separately, you set things up once and connect all your clients to it. The workflow centers on three concepts: catalogs, profiles, and clients.

https://docs.docker.com/ai/mcp-catalog-and-toolkit/catalog/

are curated collections of MCP servers. The Docker MCP Catalog provides 300+ verified servers packaged as container images with versioning, provenance, and security updates. Organizations can create

custom catalogs

https://docs.docker.com/ai/mcp-catalog-and-toolkit/catalog/#custom-catalogs

with approved servers for their teams.

https://docs.docker.com/ai/mcp-catalog-and-toolkit/profiles/

organize servers into named collections for different projects. Your "web-dev" profile might use GitHub and Playwright; your "backend" profile, database tools. Profiles support both containerized servers from catalogs and remote MCP servers. Configure a profile once, then share it across clients or with your team.
...
Learn how to quickly install and use the MCP Toolkit to set up servers and clients.\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/get-started/)

MCP Catalog

Browse Docker's curated collection of verified MCP servers\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/catalog/)

MCP Profiles

Organize servers into profiles for different projects and share configurations\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/profiles/)

MCP Toolkit

Use Docker Desktop's UI to discover, configure, and manage MCP servers\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/toolkit/)

MCP Gateway

Use the CLI and Gateway to run MCP servers with custom configurations\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/mcp-gateway/)

Dynamic MCP

Discover and add MCP servers on-demand using natural language\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/dynamic-mcp/)

Docker Hub MCP server

Use the Docker Hub MCP server to search images and manage repositories\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/hub-mcp/)

Security FAQs

Common questions about MCP security, credentials, and server verification\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/faqs/)

E2B sandboxes

Cloud sandboxes for AI agents with built-in MCP Catalog access\](https://docs.docker.com/ai/mcp-catalog-and-toolkit/e2b-sandboxes/)

Edit this page

https://github.com/docker/docs/edit/main/content/manuals/ai/mcp-catalog-and-toolkit/\_index.md

Request changes

https://github.com/docker/docs/issues/new?template=doc\_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fai%2fmcp-catalog-and-toolkit%2f&labels=status%2Ftriage
