---
sourceFile: "Tutorial: Work with agents in VS Code"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.777Z"
---

# Tutorial: Work with agents in VS Code

40f8ec14-479b-4272-8176-6c5b2fe6685c

Tutorial: Work with agents in VS Code

38e88c50-09f1-4a4d-9592-9f6f5d8fa2fe
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#setup-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#getstarted-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#copilot-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#copilot-concepts-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#copilot-agents-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#copilot-chat-articles
...
https://code.visualstudio.com/docs/copilot/chat/chat-artifacts
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#copilot-customization-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#copilot-guides-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#copilot-reference-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#configure-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#configure-extensions-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#configure-accessibility-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#editing-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#editing-workspaces-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#debugtest-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#sourcecontrol-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#terminal-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#enterprise-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#languages-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#nodejs-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#typescript-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#python-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#java-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#cpp-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#csharp-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#containers-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#datascience-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#intelligentapps-articles
...
https://code.visualstudio.com/docs/intelligentapps/tool-catalog
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#intelligentapps-reference-articles
...
https://code.visualstudio.com/docs/intelligentapps/reference/migrate-from-visualizer

https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#azure-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#remote-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#devcontainers-articles
...
https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#reference-articles
...
On this page there are 5 sections On this page

Prerequisites

https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#\_prerequisites

Step 1: Use a local agent to scaffold an app

https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#\_step-1-use-a-local-agent-to-scaffold-an-app

Step 2: Use Copilot CLI to implement a feature plan

https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#\_step-2-use-copilot-cli-to-implement-a-feature-plan

Step 3: Use a cloud agent to collaborate on a feature

https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#\_step-3-use-a-cloud-agent-to-collaborate-on-a-feature

https://code.visualstudio.com/docs/copilot/agents/agents-tutorial#\_next-steps

Test web apps with browser agent tools
...
and get a monthly limit of inline suggestions and chat interactions.
...
extension installed in VS Code (for previewing the todo app)

A GitHub account

https://docs.github.com/en/get-started/start-your-journey/creating-an-account-on-github

(for cloud agent workflow)
...
Create a new project folder and ensure it's under Git version control. Bash
...
Open the Chat view ( ⌃⌘I (Windows, Linux Ctrl+Alt+I)) and select

from the Agents dropdown. Optionally, choose a specific language model if you have a preference. Important If you don't see the agent option, make sure agents are enabled in your VS Code settings ( chat.agent.enabled Open in VS Code Open in VS Code Insiders This setting is managed at the organization level. Contact your administrator to change it. ORG). Your organization might also have disabled agents - contact your admin to enable this functionality.

Enter the following prompt in the chat input field to scaffold the todo app and select
...
Review as the agent generates the different files for the app. Use

to accept or reject changes as needed.

You can preview the changes in the integrated browser.

Enable the integrated browser for

URLs by configuring workbench.browser.openLocalhostLinks Open in VS Code Open in VS Code Insiders

file and select the

Note If you don't see the preview button, make sure you have the
...
Send additional prompts to enhance the app further. Notice that the preview updates live as you make changes. For example, you can ask: Prompt
...
First, commit your current changes in the Source Control view to have a clean state.

In the Chat view, select

New Chat (+)

to start a new local agent session. Notice that your previous chat session is preserved in the sessions list.

from the Agents dropdown to switch to the plan agent and enter the following prompt: Prompt (Plan)
...
to hand off the plan to Copilot CLI.

Copilot CLI creates a Git worktree where it starts implementing the feature. When asked, select

Copy Changes

to make sure all current changes are available to Copilot CLI.

You can track the Copilot CLI session in the

view. Select the session to see details about its progress. Tip While Copilot CLI works in the background, you can continue editing your main workspace without conflicts.

Once the agent finishes, select any of the changed files to review its changes, or select

View All Changes

to open a multi-file diff editor with all the changes. Tip You can send follow-up prompts to Copilot CLI to make adjustments or improvements to the feature.

In the Chat view, select

to apply the changes to your main workspace.
...
command from the Command Palette ( ⇧⌘P (Windows, Linux Ctrl+Shift+P)) and follow the prompts to create a new repository.

Git: Add Remote

command from the Command Palette and follow the prompts to add your GitHub repository as a remote.

In the Chat view, select

New Chat (+)

from the session type dropdown to switch to a cloud agent and enter the following prompt: Text
...
The cloud agent starts a new session to work on your request. It creates a branch and pull request in your GitHub repository.

You can track the cloud agent in the

view in the Chat view or select the link to view the pull request details. Tip If you have the GitHub Pull Requests extension installed, you can also track the pull request progress in the

Copilot on my Behalf

view in the GitHub Pull Requests view.

Once completed, the cloud agent assigns the pull request to you for review.

Right-click the cloud agent session in the

view to view additional options or select the session and choose
...
Plan and research tasks with the Plan agent
