---
sourceFile: "Trusted content | Docker Docs"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.767Z"
---

# Trusted content | Docker Docs

b8285bd4-4298-4e12-8007-4b5769c81e91

Trusted content | Docker Docs

46fdbce0-4706-4212-a2b9-08be41beb37c
...
https://docs.docker.com/docker-hub/image-library/trusted-content/#docker-official-images

Supported tags and respective Dockerfile links

https://docs.docker.com/docker-hub/image-library/trusted-content/#supported-tags-and-respective-dockerfile-links

Slim images

https://docs.docker.com/docker-hub/image-library/trusted-content/#slim-images

Alpine images

https://docs.docker.com/docker-hub/image-library/trusted-content/#alpine-images

https://docs.docker.com/docker-hub/image-library/trusted-content/#codenames

https://docs.docker.com/docker-hub/image-library/trusted-content/#other-tags

Troubleshooting failed pulls

https://docs.docker.com/docker-hub/image-library/trusted-content/#troubleshooting-failed-pulls

Docker Hardened Images

https://docs.docker.com/docker-hub/image-library/trusted-content/#docker-hardened-images

Verified Publisher images

https://docs.docker.com/docker-hub/image-library/trusted-content/#verified-publisher-images

Docker-Sponsored Open Source Software images

https://docs.docker.com/docker-hub/image-library/trusted-content/#docker-sponsored-open-source-software-images
...
, programming language runtimes such as

https://hub.docker.com/\_/python

https://hub.docker.com/\_/node

, and other essential tools such as

https://hub.docker.com/\_/memcached

https://hub.docker.com/\_/mysql

The images are some of the

most secure images

https://www.docker.com/blog/enhancing-security-and-transparency-with-docker-official-images/

on Docker Hub. This is particularly important as Docker Official Images are some of the most popular on Docker Hub. Typically, Docker Official images have few or no packages containing CVEs.
...
section that lists all the current tags with links to the Dockerfiles that created the image with those tags. The purpose of this section is to show what image variants are available.

Tags listed on the same line all refer to the same underlying image. Multiple tags can point to the same image. For example, in the previous screenshot taken from the

Docker Official Images repository, the tags

noble-20240225

all refer to the same image.

tag for a Docker Official Image is often optimized for ease of use and includes a wide variety of useful software, such as developer and build tools. By tagging an image as

, the image maintainers are essentially suggesting that image be used as the default. In other words, if you do not know what tag to use or are unfamiliar with the underlying software, you should probably start with the

image. As your understanding of the software and image variants advances, you may find other image variants better suit your needs.
...
tag variants designed to provide a lightweight, production-ready base image with fewer packages.

A typical consumption pattern for
...
. For example, you build your application in the first stage of the build using the

variant and then copy your application into the final stage based upon the
...
Many Docker Official Images repositories also offer

variants. These images are built on top of the

Alpine Linux

https://www.alpinelinux.org/

distribution rather than Debian or Ubuntu. Alpine Linux is focused on providing a small, simple, and secure base for container images, and Docker Official Images

variants typically aim to install only necessary packages. As a result, Docker Official Images

variants are typically even smaller than

The main caveat to note is that Alpine Linux uses

https://musl.libc.org/

https://www.gnu.org/software/libc/

. Additionally, to minimize image size, it's uncommon for Alpine-based images to include tools such as Git or Bash by default. Depending on the depth of libc requirements or assumptions in your programs, you may find yourself running into issues due to missing libraries or tools.
...
on Docker Hub for examples on how to install packages if you are unfamiliar.

https://docs.docker.com/docker-hub/image-library/trusted-content/#codenames

Tags with words that look like Toy Story characters (for example,

) or adjectives (such as

), indicate the codename of the Linux distribution they use as a base image. Debian release codenames are

based on Toy Story characters

https://en.wikipedia.org/wiki/Debian\_version\_history#Naming\_convention

, and Ubuntu's take the form of "Adjective Animal". For example, the codename for Ubuntu 24.04 is "Noble Numbat".

Linux distribution indicators are helpful because many Docker Official Images provide variants built upon multiple underlying distribution versions (for example,
...
If you're experiencing failed pulls of Docker Official Images, check whether the

DOCKER\_CONTENT\_TRUST

environment variable is set to

. Starting in August 2025, Docker Content Trust signing certificates for Docker Official Images began expiring. To resolve pull failures, unset the

DOCKER\_CONTENT\_TRUST

environment variable. For more details, see the

DCT retirement blog post
...
To browse available repositories, see the
...
https://github.com/docker/docs/edit/main/content/manuals/docker-hub/image-library/trusted-content.md

Request changes

https://github.com/docker/docs/issues/new?template=doc\_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fdocker-hub%2fimage-library%2ftrusted-content%2f&labels=status%2Ftriage
