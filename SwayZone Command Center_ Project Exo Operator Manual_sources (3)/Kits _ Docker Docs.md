---
sourceFile: "Kits | Docker Docs"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.595Z"
---

# Kits | Docker Docs

dc0ba874-2b53-4874-b641-15aaddd2a7c8

Kits | Docker Docs

b3f30e26-da71-4bc0-bd56-3e38e056a8c0
...
https://docs.docker.com/ai/sandboxes/agents/cursor/
...
https://docs.docker.com/ai/sandboxes/security/governance/
...
https://docs.docker.com/ai/gordon/use-cases/

Capabilities

https://docs.docker.com/ai/gordon/concepts/capabilities/

Data privacy

https://docs.docker.com/ai/gordon/concepts/data-privacy/

How-to guides

Docker Desktop

https://docs.docker.com/ai/gordon/how-to/docker-desktop/

https://docs.docker.com/ai/gordon/how-to/cli/

Permissions

https://docs.docker.com/ai/gordon/how-to/permissions/

Configure tools

https://docs.docker.com/ai/gordon/how-to/configure-tools/
...
https://docs.docker.com/ai/docker-agent/model-providers/
...
https://docs.docker.com/ai/docker-agent/best-practices/

Sharing agents

https://docs.docker.com/ai/docker-agent/sharing-agents/

Integrations

https://docs.docker.com/ai/docker-agent/integrations/

https://docs.docker.com/ai/docker-agent/integrations/a2a/

https://docs.docker.com/ai/docker-agent/integrations/acp/
...
https://docs.docker.com/ai/docker-agent/reference/toolsets/

https://docs.docker.com/ai/docker-agent/reference/cli/

https://docs.docker.com/ai/docker-agent/reference/examples/

https://docs.docker.com/ai/docker-agent/rag/
...
https://docs.docker.com/engine/containers/multi-service\_container/

Resource constraints

https://docs.docker.com/engine/containers/resource\_constraints/
...
https://docs.docker.com/engine/logging/log\_tags/
...
https://docs.docker.com/engine/security/trust/trust\_automation/

Delegations for content trust

https://docs.docker.com/engine/security/trust/trust\_delegation/

Deploy Notary Server with Compose

https://docs.docker.com/engine/security/trust/deploying\_notary/

Manage keys for content trust

https://docs.docker.com/engine/security/trust/trust\_key\_mng/

Play in a content trust sandbox

https://docs.docker.com/engine/security/trust/trust\_sandbox/
...
https://docs.docker.com/engine/extend/plugins\_logging/

Docker network driver plugins

https://docs.docker.com/engine/extend/plugins\_network/

Docker Plugin API

https://docs.docker.com/engine/extend/plugin\_api/

Docker volume plugins

https://docs.docker.com/engine/extend/plugins\_volume/
...
https://docs.docker.com/engine/extend/legacy\_plugins/
...
https://docs.docker.com/offload/configuration/

https://docs.docker.com/offload/usage/

Optimize usage

https://docs.docker.com/offload/optimize/

Troubleshoot

https://docs.docker.com/offload/troubleshoot/

Give feedback

https://docs.docker.com/offload/feedback/
...
https://docs.docker.com/build/bake/stdlib/
...
https://docs.docker.com/build/ci/github-actions/github-builder/architecture/

Build workflow

https://docs.docker.com/build/ci/github-actions/github-builder/build/
...
https://docs.docker.com/build/policies/validate-git/

Templates & examples

https://docs.docker.com/build/policies/examples/

https://docs.docker.com/build/policies/testing/

https://docs.docker.com/build/policies/debugging/

Input reference

https://docs.docker.com/build/policies/inputs/

Built-in functions

https://docs.docker.com/build/policies/built-ins/
...
https://docs.docker.com/dhi/features/

https://docs.docker.com/dhi/explore/
...
https://docs.docker.com/dhi/explore/build-process/

Image types

https://docs.docker.com/dhi/explore/available/

Scanner integrations

https://docs.docker.com/dhi/explore/scanner-integrations/

Image testing

https://docs.docker.com/dhi/explore/test/

Responsibility overview

https://docs.docker.com/dhi/explore/responsibility/

Malware scanning

https://docs.docker.com/dhi/explore/malware-scanning/

https://docs.docker.com/dhi/explore/feedback/

https://docs.docker.com/dhi/migration/

Migration checklist

https://docs.docker.com/dhi/migration/checklist/

AI-assisted migration Experimental

https://docs.docker.com/dhi/migration/migrate-with-ai/

Migrate from Alpine or Debian

https://docs.docker.com/dhi/migration/migrate-from-doi/

Migrate from Ubuntu

https://docs.docker.com/dhi/migration/migrate-from-ubuntu/

Migrate from Wolfi

https://docs.docker.com/dhi/migration/migrate-from-wolfi/

Migration examples

https://docs.docker.com/dhi/migration/examples/

https://docs.docker.com/dhi/migration/examples/go/

https://docs.docker.com/dhi/migration/examples/python/

https://docs.docker.com/dhi/migration/examples/node/

https://docs.docker.com/dhi/how-to/

Search and evaluate

https://docs.docker.com/dhi/how-to/explore/

Mirror a repository

https://docs.docker.com/dhi/how-to/mirror/
...
https://docs.docker.com/dhi/how-to/use/

Use a Helm chart

https://docs.docker.com/dhi/how-to/helm/

Use hardened packages

https://docs.docker.com/dhi/how-to/hardened-packages/
...
https://docs.docker.com/dhi/how-to/scan/

Enforce image usage

https://docs.docker.com/dhi/how-to/policies/
...
https://docs.docker.com/dhi/how-to/select-enterprise/

Core concepts

https://docs.docker.com/dhi/core-concepts/

Attestations

https://docs.docker.com/dhi/core-concepts/attestations/
...
https://docs.docker.com/dhi/core-concepts/fips/
...
https://docs.docker.com/dhi/core-concepts/provenance/
...
https://docs.docker.com/dhi/core-concepts/ssdlc/

https://docs.docker.com/dhi/core-concepts/stig/

https://docs.docker.com/dhi/core-concepts/vex/

Troubleshoot

https://docs.docker.com/dhi/troubleshoot/

Additional resources

https://docs.docker.com/dhi/resources/
...
https://docs.docker.com/docker-hub/repos/manage/hub-images/bulk-migrate/
...
https://docs.docker.com/docker-hub/settings/
...
https://docs.docker.com/accounts/general-faqs/
...
https://docs.docker.com/security/2fa/recover-hub-account/
...
https://www.docker.com/pricing?ref=Docs&refAction=DocsSubscriptionDetails
...
https://docs.docker.com/admin/organization/setup/orgs/

https://docs.docker.com/admin/organization/setup/onboard/

Change information

https://docs.docker.com/admin/organization/setup/general-settings/

Convert account

https://docs.docker.com/admin/organization/setup/convert-account/

https://docs.docker.com/admin/organization/manage/members/

https://docs.docker.com/admin/organization/manage/manage-a-team/

Docker products

https://docs.docker.com/admin/organization/manage/manage-products/

https://docs.docker.com/admin/organization/deactivate-account/

https://docs.docker.com/admin/organization/organization-faqs/
...
https://docs.docker.com/admin/company/manage/organizations/

https://docs.docker.com/admin/company/manage/owners/

https://docs.docker.com/admin/company/manage/users/

https://docs.docker.com/admin/company/company-faqs/

Activity logs

https://docs.docker.com/admin/activity-logs/

https://docs.docker.com/admin/insights/

Deploy Docker Desktop

https://docs.docker.com/enterprise/enterprise-deployment/
...
https://docs.docker.com/enterprise/enterprise-deployment/pkg-install-and-configure/

https://docs.docker.com/enterprise/enterprise-deployment/ms-store/

Deploy with Intune

https://docs.docker.com/enterprise/enterprise-deployment/use-intune/

Deploy with Jamf Pro

https://docs.docker.com/enterprise/enterprise-deployment/use-jamf-pro/

Microsoft Dev Box

https://docs.docker.com/enterprise/enterprise-deployment/dev-box/

https://docs.docker.com/enterprise/enterprise-deployment/faq/

https://docs.docker.com/enterprise/security/

Add and manage domains

https://docs.docker.com/enterprise/security/domain-management/

Single sign-on

https://docs.docker.com/enterprise/security/single-sign-on/

https://docs.docker.com/enterprise/security/single-sign-on/connect/

Manage connections

https://docs.docker.com/enterprise/security/single-sign-on/manage/

Troubleshoot

https://docs.docker.com/enterprise/security/single-sign-on/troubleshoot-sso/

https://docs.docker.com/enterprise/security/single-sign-on/faqs/general/

https://docs.docker.com/enterprise/security/single-sign-on/faqs/domain-faqs/

Enforcement

https://docs.docker.com/enterprise/security/single-sign-on/faqs/enforcement-faqs/

Identity providers

https://docs.docker.com/enterprise/security/single-sign-on/faqs/idp-faqs/

User management

https://docs.docker.com/enterprise/security/single-sign-on/faqs/users-faqs/

https://docs.docker.com/enterprise/security/provisioning/

https://docs.docker.com/enterprise/security/provisioning/scim/

https://docs.docker.com/enterprise/security/provisioning/scim/provision-scim/

Group mapping

https://docs.docker.com/enterprise/security/provisioning/scim/group-mapping/

https://docs.docker.com/enterprise/security/provisioning/scim/migrate-scim/

Just-in-Time

https://docs.docker.com/enterprise/security/provisioning/just-in-time/

Auto-provision

https://docs.docker.com/enterprise/security/provisioning/auto-provisioning/

Troubleshoot

https://docs.docker.com/enterprise/security/provisioning/troubleshoot-provisioning/

Enforce sign-in

https://docs.docker.com/enterprise/security/enforce-sign-in/

https://docs.docker.com/enterprise/security/enforce-sign-in/methods/

Roles and permissions

https://docs.docker.com/enterprise/security/roles-and-permissions/

https://docs.docker.com/enterprise/security/roles-and-permissions/core-roles/

Custom roles

https://docs.docker.com/enterprise/security/roles-and-permissions/custom-roles/

Hardened Docker Desktop

https://docs.docker.com/enterprise/security/hardened-desktop/

Enhanced Container Isolation

https://docs.docker.com/enterprise/security/hardened-desktop/enhanced-container-isolation/

https://docs.docker.com/enterprise/security/hardened-desktop/enhanced-container-isolation/enable-eci/

Configure advanced settings

https://docs.docker.com/enterprise/security/hardened-desktop/enhanced-container-isolation/config/

Limitations

https://docs.docker.com/enterprise/security/hardened-desktop/enhanced-container-isolation/limitations/

https://docs.docker.com/enterprise/security/hardened-desktop/enhanced-container-isolation/faq/
...
https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/configure-admin-console/

Desktop settings reporting

https://docs.docker.com/enterprise/security/hardened-desktop/settings-management/compliance-reporting/
...
https://docs.docker.com/enterprise/security/hardened-desktop/registry-access-management/

Image Access Management

https://docs.docker.com/enterprise/security/hardened-desktop/image-access-management/

Namespace access

https://docs.docker.com/enterprise/security/hardened-desktop/namespace-access/
...
https://docs.docker.com/ai/sandboxes/customize/kits/#what-kits-can-do

Run commands

https://docs.docker.com/ai/sandboxes/customize/kits/#run-commands

Inject files

https://docs.docker.com/ai/sandboxes/customize/kits/#inject-files

Set environment variables

https://docs.docker.com/ai/sandboxes/customize/kits/#set-environment-variables

Control network access

https://docs.docker.com/ai/sandboxes/customize/kits/#control-network-access

Authenticate to external services

https://docs.docker.com/ai/sandboxes/customize/kits/#authenticate-to-external-services

Define an agent

https://docs.docker.com/ai/sandboxes/customize/kits/#define-an-agent

https://docs.docker.com/ai/sandboxes/customize/kits/#mixin-kits

Example: Python linting kit

https://docs.docker.com/ai/sandboxes/customize/kits/#example-python-linting-kit

https://docs.docker.com/ai/sandboxes/customize/kits/#agent-kits

Example: the built-in claude agent

https://docs.docker.com/ai/sandboxes/customize/kits/#example-the-built-in-claude-agent

https://docs.docker.com/ai/sandboxes/customize/kits/#using-kits

https://docs.docker.com/ai/sandboxes/customize/kits/#local

Git repository

https://docs.docker.com/ai/sandboxes/customize/kits/#git-repository

OCI registry

https://docs.docker.com/ai/sandboxes/customize/kits/#oci-registry

Packaging and distribution

https://docs.docker.com/ai/sandboxes/customize/kits/#packaging-and-distribution

Spec reference

https://docs.docker.com/ai/sandboxes/customize/kits/#spec-reference

Top-level fields

https://docs.docker.com/ai/sandboxes/customize/kits/#top-level-fields

Credentials

https://docs.docker.com/ai/sandboxes/customize/kits/#credentials

https://docs.docker.com/ai/sandboxes/customize/kits/#network

Environment

https://docs.docker.com/ai/sandboxes/customize/kits/#environment

https://docs.docker.com/ai/sandboxes/customize/kits/#commands

Static files

https://docs.docker.com/ai/sandboxes/customize/kits/#static-files

Agent block

https://docs.docker.com/ai/sandboxes/customize/kits/#agent-block

https://docs.docker.com/ai/sandboxes/customize/kits/#debugging

Availability: Early Access

Kits are experimental. The kit file format, CLI commands, and experience for creating, loading, and managing kits are subject to change as the feature evolves. Share feedback and bug reports in the
...
You declare these in a single

file, point the CLI at the directory (or a ZIP, OCI artifact, or Git URL), and the sandbox applies and enforces them at runtime. Credentials stay on the host and go through a proxy instead of entering the VM, and outbound traffic is restricted to the domains permitted by the kit's network rules.
...
) extend an existing agent with extra capabilities. Stack several on the same sandbox.

Agent kits (

kind: agent

) define a full agent from scratch: its image, entrypoint, network policies, and everything else the agent needs.
...
A kit can run commands inside the sandbox automatically.
...
run each time the sandbox starts.

Install commands are the place to put anything an agent needs into the image, via
...
Startup commands cover things like launching background services, warming caches, or refreshing config on each start. They must be idempotent — see the

https://docs.docker.com/ai/sandboxes/customize/kits/#startup
...
#### Kits can inject files into the sandbox in two ways:

static files

bundled with the kit, and

written at startup with runtime values substituted in.
...
cover content that depends on runtime values, such as an absolute workspace path that a tool needs to bake into its config file at startup:
...
https://docs.docker.com/ai/sandboxes/customize/kits/#initfiles

in the spec reference for all fields.
...
environment:
  variables:
    MY\_TOOL\_WORKSPACE: /home/agent/my-tool
...
. Don't put secret values directly in

environment.variables

— they'd be visible inside the sandbox VM.
...
for hosts the agent needs, such as package registries, install endpoints, or external APIs. Use

deniedDomains

for hosts the agent should not reach, such as telemetry endpoints. If a domain matches both an allow rule and a deny rule, the deny rule wins.
...
The standard pattern uses four blocks tied to a service identifier you choose (here,
...
credentials:
  sources:
    my-service:
      env:
        - MY\_SERVICE\_API\_KEY # Host-side credential lookup

environment:
  proxyManaged:
    - MY\_SERVICE\_API\_KEY # Set the in-VM env var to "proxy-managed"

The agent boots with

MY\_SERVICE\_API\_KEY=proxy-managed

, sends a request with that value in

Authorization

, and the proxy overwrites the header with the real credential before forwarding. The real secret never enters the VM.

Credentials

https://docs.docker.com/ai/sandboxes/security/credentials/

for how to provide the credential value on your host, other approaches for cases the example above doesn't fit, and what the proxy does at request time.

Define an agent

https://docs.docker.com/ai/sandboxes/customize/kits/#define-an-agent

Agent kits declare an

block with the image the agent runs in and the command the user attaches to when they launch the sandbox:
...
and injects a shared configuration file, so every sandbox starts with the same linting setup.
...
The templates for the built-in agents (

, etc) already includes

, so this mixin can use it without installing it separately.
...
flag only takes effect when a sandbox is created.
...
that tells the sandbox how to launch the agent. For a step-by-step walkthrough, see
...
is defined as a kit. Here is an abbreviated version of its spec, showing how the agent block combines with network, credentials, environment, and commands:
...
Kits can be loaded from a local path (a directory or ZIP file), a Git repository, or an OCI registry. Pass

more than once to stack several kits on the same sandbox.

only takes effect when a sandbox is created. Passing it against an existing sandbox name fails with

--kit can only be used when creating a new sandbox

. To extend a running sandbox with a kit, use
...
at a directory or ZIP file on disk:
...
re-runs install commands and re-copies files. Kits can't be removed from a running sandbox — remove and recreate it to start clean.
...
pins to a specific revision. Defaults to the repository's default branch.

#dir=<path>

loads a kit from a subdirectory.

URLs also work, using your local SSH agent, Git credential helpers, and

Quote the URL in shells where
...
For Docker Hub, include the full
...
Private kits are only supported on Docker Hub.

reuses your

session to pull private artifacts from Docker Hub. Other registries are pulled anonymously, so private kits hosted on registries other than Docker Hub fail to pull.

Packaging and distribution

https://docs.docker.com/ai/sandboxes/customize/kits/#packaging-and-distribution

subcommands validate, inspect, and publish kits:

sbx kit validate <path>

— check that a kit directory or ZIP is well-formed.

sbx kit inspect <path>

— display kit details. Add

for machine-readable output.

sbx kit pack <path> -o <file.zip>

— package a directory as a ZIP file for sharing.

sbx kit push <path> <ref>

— publish to an OCI registry (for example,

ghcr.io/myorg/my-kit:1.0

sbx kit pull <ref>

— download a kit from a registry as a ZIP file to the working directory.

For Docker Hub, include the full

doesn't add it automatically.

Spec reference

https://docs.docker.com/ai/sandboxes/customize/kits/#spec-reference

A kit directory has a required
...
Spec schema version. Set to

for kits that extend an agent;

for kits that define one.
...
Map of service identifier to credential source.

sources.<id>.env

Environment variables to read on the host, in priority order.

sources.<id>.file.path

Path on host.

expands to home.

sources.<id>.file.parser

How to extract the value (for example,
...
Service identifiers link credentials to
...
Domains the sandbox can reach. Wildcards supported.

deniedDomains

Domains the sandbox can't reach. Deny rules take precedence.

serviceDomains

Map of domain to service identifier from

credentials.sources

serviceAuth.headerName

HTTP header the proxy sets (for example,

Authorization

serviceAuth.valueFormat

Format string for the header value (for example,
...
Key-value pairs set directly in the container.

proxyManaged

Environment variable names populated by the proxy at request time. Pair with
...
https://docs.docker.com/ai/sandboxes/customize/kits/#install

Runs once during sandbox creation. Shell strings passed to
...
Command and args as a string array.
...
will hang or fail). They also don't gate the agent's entrypoint: the agent launches once startup commands have been dispatched, regardless of

. Use them for non-interactive prep — launching daemons, warming caches, refreshing config — and use

commands.initFiles

for any value that needs to land on disk before the agent runs.
...
Parent directories are created automatically. Existing files are overwritten. Absolute paths and path-traversal sequences (
...
Memory filename (for example,

). Appends top-level

https://docs.docker.com/ai/sandboxes/customize/kits/#memory

at creation.

agent.persistence

(named volume across restarts) or

agent.entrypoint.run

Command and args as a string array. Replaces the image's entrypoint.

agent.entrypoint.args

Args appended to the image's existing entrypoint.
...
user at UID 1000 with passwordless sudo.

/home/agent/

home directory owned by
...
Top-level field. Markdown appended to the agent's memory file at sandbox creation. The agent reads this content at startup, so write it as instructions or notes the agent should follow when working in the sandbox. Applied only when

agent.aiFilename

The file is written to the parent of the workspace path inside the sandbox, not to the workspace itself. For a workspace mounted at

/Users/you/myproject

, the memory file lands at

/Users/you/AGENTS.md

(or whatever

is set to). It exists only inside the sandbox — nothing is written to the host.
...
shows every outbound request the sandbox proxy saw, the rule it matched, extra context when available, and its
...
. Use it to diagnose install-time download failures, blocked domains, and unexpected TLS interception. If downloads fail or arrive corrupted after you add

serviceDomains

, check whether the service mapping is too broad. Map only the hosts that need credential injection.

sbx exec <sandbox> -- <cmd>

runs an arbitrary command inside an existing sandbox. Useful for inspecting post-install state without recreating:

which mytool

ls /home/agent/.local/bin/

cat /home/agent/.config/...

, and so on.

Install and startup command output is only emitted during

doesn't retain it for later inspection. To repeat setup with fresh output, remove and recreate the sandbox:

sbx rm <sandbox> && sbx run ...

Edit this page

https://github.com/docker/docs/edit/main/content/manuals/ai/sandboxes/customize/kits.md

Request changes

https://github.com/docker/docs/issues/new?template=doc\_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fai%2fsandboxes%2fcustomize%2fkits%2f&labels=status%2Ftriage
