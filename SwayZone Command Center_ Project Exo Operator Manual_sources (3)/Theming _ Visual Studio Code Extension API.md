---
sourceFile: "Theming | Visual Studio Code Extension API"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.746Z"
---

# Theming | Visual Studio Code Extension API

5a4e81b3-ca94-4f5e-8109-207ecbb314f5

Theming | Visual Studio Code Extension API

23f12c8c-3a0d-4679-8dfc-2a12b9d90850
...
https://code.visualstudio.com/api/extension-capabilities/theming#get-started-articles
...
https://code.visualstudio.com/api/extension-capabilities/theming#extension-capabilities-articles
...
https://code.visualstudio.com/api/extension-capabilities/theming#extension-guides-articles

https://code.visualstudio.com/api/extension-guides/overview

https://code.visualstudio.com/api/extension-capabilities/theming#extension-guides-ai-articles
...
https://code.visualstudio.com/api/extension-capabilities/theming#ux-guidelines-articles
...
https://code.visualstudio.com/api/extension-capabilities/theming#language-extensions-articles
...
https://code.visualstudio.com/api/extension-capabilities/theming#working-with-extensions-articles
...
https://code.visualstudio.com/api/extension-capabilities/theming#advanced-topics-articles
...
https://code.visualstudio.com/api/extension-capabilities/theming#references-articles
...
: A mapping from both UI Component Identifier and Text Token Identifier to colors. Color theme allows you to apply your favorite colors to both VS Code UI Components and the text in the editor.

File Icon Theme

: A mapping from file type / file name to images. File icons are displayed across the VS Code UI in places such as File Explorer, Quick Open List, and Editor Tab.

Product Icon Theme

: A set of icons used throughout the UI, from the Side bar, the Activity bar, status bar to the editor glyph margin.

Color Theme

https://code.visualstudio.com/api/extension-capabilities/theming#color-theme
...
mapping that controls colors for UI Components.

tokenColors

define the color and styles for highlighting in the editor. The
...
https://code.visualstudio.com/api/extension-capabilities/theming#file-icon-theme
...
File Icon Theme guide

https://code.visualstudio.com/api/extension-guides/file-icon-theme

discusses how to create a File Icon Theme.

Product Icon Theme

https://code.visualstudio.com/api/extension-capabilities/theming#product-icon-theme
