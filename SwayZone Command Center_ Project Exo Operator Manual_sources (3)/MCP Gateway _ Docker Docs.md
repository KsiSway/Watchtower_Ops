---
sourceFile: "MCP Gateway | Docker Docs"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.631Z"
---

# MCP Gateway | Docker Docs

bcb633e2-0f80-481f-8ca5-847e588648e6

MCP Gateway | Docker Docs

f1e7bba6-5112-41c6-be5e-cae7f015fa32
...
https://docs.docker.com/ai/mcp-catalog-and-toolkit/mcp-gateway/#how-it-works

https://docs.docker.com/ai/mcp-catalog-and-toolkit/mcp-gateway/#usage

Install the MCP Gateway manually

https://docs.docker.com/ai/mcp-catalog-and-toolkit/mcp-gateway/#install-the-mcp-gateway-manually

Additional information

https://docs.docker.com/ai/mcp-catalog-and-toolkit/mcp-gateway/#additional-information
...
When using MCP servers without the MCP Gateway, you need to configure applications individually for each AI application. With the MCP Gateway, you configure applications to connect to the Gateway. The Gateway then handles server lifecycle, routing, and authentication across all servers in your
...
E2B sandboxes now include direct access to the Docker MCP Catalog, giving developers access to over 200 tools and services to seamlessly build and run AI agents. For more information, see
...
The Gateway works with profiles to determine which servers are available. When you run the Gateway, you specify which profile to use with the

flag to determine which servers are made available to clients.

https://docs.docker.com/ai/mcp-catalog-and-toolkit/mcp-gateway/#usage

To use the MCP Gateway, you'll need Docker Desktop with MCP Toolkit enabled. Follow the

MCP Toolkit guide

https://docs.docker.com/ai/mcp-catalog-and-toolkit/toolkit/

to enable and configure servers through the Docker Desktop interface, or see
...
For more details on how the MCP Gateway works and available customization options, see the complete documentation

https://github.com/docker/mcp-gateway

Edit this page

https://github.com/docker/docs/edit/main/content/manuals/ai/mcp-catalog-and-toolkit/mcp-gateway.md

Request changes

https://github.com/docker/docs/issues/new?template=doc\_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fai%2fmcp-catalog-and-toolkit%2fmcp-gateway%2f&labels=status%2Ftriage
