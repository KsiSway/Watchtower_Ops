---
sourceFile: "Build a named entity recognition app | Docker Docs"
exportedBy: "Kortex"
exportDate: "2026-05-15T09:23:16.147Z"
---

# Build a named entity recognition app | Docker Docs

2927063e-09ad-4e9c-9715-27fb27ede1ce

Build a named entity recognition app | Docker Docs

2f38522a-bf3f-405f-b97e-1690189c2ae4
...
https://docs.docker.com/guides/named-entity-recognition/#overview

Prerequisites

https://docs.docker.com/guides/named-entity-recognition/#prerequisites

Get the sample application

https://docs.docker.com/guides/named-entity-recognition/#get-the-sample-application

Explore the application code

https://docs.docker.com/guides/named-entity-recognition/#explore-the-application-code

Explore the application environment

https://docs.docker.com/guides/named-entity-recognition/#explore-the-application-environment

Run the application

https://docs.docker.com/guides/named-entity-recognition/#run-the-application

https://docs.docker.com/guides/named-entity-recognition/#summary

https://docs.docker.com/guides/named-entity-recognition/#next-steps
...
The source code for the name recognition application is in the

Docker-NLP/02\_name\_entity\_recognition.py
...
function loads a language model. The
...
input\_text = input("Enter the text for entity recognition (type 'exit' to end): ")
...
and breaks out of the while loop, effectively ending the program.
...
for ent in doc.ents:
   print(f"Entity: {ent.text}, Type: {ent.label\_}")

doc = nlp(input\_text)

: Here, the nlp model processes the user-input text. This creates a Doc object which contains various NLP attributes, including identified entities.

for ent in doc.ents:

: This loop iterates over the entities found in the text.
...
$ docker run -it basic-nlp 02\_name\_entity\_recognition.py
...
Test the application. Enter some information to get the named entity recognition.
...
https://github.com/docker/docs/edit/main/content/guides/named-entity-recognition.md

Request changes

https://github.com/docker/docs/issues/new?template=doc\_issue.yml&location=https%3a%2f%2fdocs.docker.com%2fguides%2fnamed-entity-recognition%2f&labels=status%2Ftriage
